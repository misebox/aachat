export const translations = {
  en: {
    ...
    stoppingCamera: 'Stopping camera...',
    cameraStartFailed: 'Could not start the camera. Check device permissions.',
  ...
  ja: {
    ...
    stoppingCamera: 'カメラ停止中...',
    cameraStartFailed: 'カメラを起動できませんでした。デバイスの権限を確認してください。',
