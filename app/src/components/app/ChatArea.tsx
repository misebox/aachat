...
export const ChatArea: Component<ChatAreaProps> = (props) => {
  return (
    <div class="chat-area flex flex-col md:flex-row items-center justify-center gap-0 md:gap-5 mx-0 md:mx-1 px-0.5 md:px-0 h-[calc(100vh-120px)] md:h-[calc(100vh-100px)] overflow-y-auto bg-neutral-900 md:bg-transparent">
      <VideoContainer
        title="Peer"
